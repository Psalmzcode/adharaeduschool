  ...
  superadmin: {
    ...
    groups:[
      ...
      {label:'Finance & Reports', items:[
        {icon:'💳',label:'Payments',section:'payments',badgeStyle:{background:'rgba(245,158,11,0.22)',color:'#FCD34D'}},
        {icon:'📋',label:'Weekly Reports',section:'reports',badgeStyle:{background:'rgba(245,158,11,0.22)',color:'#FCD34D'}},
